...
<div class="container-fluid">
  <div class="row">
    ...
    <script src="{{URL::asset('assets/js/bootstrap.js')}}"></script>
      ...
      <script src="{{URL::asset('assets/js/feather.min.js')}}">
      </script><script src="{{URL::asset('assets/js/chart.umd.min.js')}}"></script>
      </script><script src="{{URL::asset('assets/js/dashboard.js')}}"></script>
